...
# cat_lnujj_trigOrSF = "((HLT_MU||HLT_ELE||HLT_ISOMU||HLT_ISOELE||HLT_MET120)&&((run>2000)+((run<2000)*lnujj_sf)))"
cat_lnujj_trigOrSF = "((HLT_MU||HLT_ELE||HLT_ISOMU||HLT_ISOELE||HLT_MET120)&&((run>2000)+((run<2000)*1.)))"
