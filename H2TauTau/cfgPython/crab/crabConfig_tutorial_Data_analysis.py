...
config.General.workArea = 'crab_projects_bis'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/home/cms/torterotot/CMSSW/CMSSW_8_0_28_patch1/src/CMGTools/H2TauTau/cfgPython/crab/test/read_sync_file.py'
#config.JobType.psetName = '/home/cms/torterotot/CMSSW_vanilla/CMSSW_8_0_28_patch1/Colin/Common/cfg/pick_cfg.py'
